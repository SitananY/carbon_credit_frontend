  ...
  return (
    ...
    <div className="w-full  flex flex-col  py-[32px] xl:px-[148px] px-[32px]">
        ...
        <div className=" w-full h-[40px]  font-prompt text-[#27272A] items-center  flex  flex-row justify-between my-[24px] whitespace-nowrap ">
              <div className="w-auto h-[40px] text-xl font-medium">จัดการข้อมูล</div>
              <div className="w-auto h-[40px]"><InputField iconSearch  className="h-[32px] w-[287px] rounded-2xl" /></div>
              <div className="w-auto h-[40px]"><Button text="เพิ่มข้อมูล" className="w-[113px] h-[40px] rounded-lg "><Icons.Add /></Button></div>
        </div>
